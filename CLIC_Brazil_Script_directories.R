##############
### List of directories used by other scripts MAC paths
...
dir_source_data <-  "/Users/sabrinaguedes/Documents/Bragatte/GitHub/preventable_deaths/data/brazil_io/"
...
# if(Sys.info()[['user']]=="sabrinaguedes"){
